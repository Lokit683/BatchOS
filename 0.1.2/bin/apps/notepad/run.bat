...
echo.----------------
echo.
if "%dirsizeKB%" LEQ "500" ( echo. %dirsizeKB%,%ostKB%/528.00KB ) else (echo. %dirsizeKB%,%ostKB%/528.00KB Warrning!)
echo.
...
if "%dirsizeKB%" LEQ "520" ( echo. %dirsizeKB%,%ostKB%/40.00KB ) else (echo. %dirsizeKB%,%ostKB%/40.00KB Warrning!)
echo.
echo. close - close this app
echo. back - back to general
set /p newt=^>
